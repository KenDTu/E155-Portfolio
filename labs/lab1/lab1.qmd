...
![Figure 4: QuestSim simulation square wave form](images/simulation.png)
:::

::: {.callout-note collapse="true"}
## Figure 5: Testbench
![Figure 5: QuestSim simulation showing the internal signals and passing LED test cases for the one line assign statements and the seven segment as well as the cases for the counter and enable functionality](images/test.png)
:::
...
![Figure 6: Radiant Software demonstrates that the files did not compile and fails](images/ai1.png)
:::

::: {.callout-note collapse="true"}
## Figure 7: Recomplation for correction
![Figure 7: Recomplication after the LLM was prompted to correct itself. SystemVerilog code included. Still led to a failed simulation](images/ai2.png)
:::
